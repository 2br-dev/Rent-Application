...
function setEditable(e){
    ...
    let allowedCodes = [8,35,36,37,39,46,110,191,16,48,49,49,50,51,52,53,54,55,56,57,96,97,98,99,100,101,102,103,104,105];
    let allowedIndex = allowedCodes.indexOf(code);
